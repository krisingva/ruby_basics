...
# The return for using puts balance is the return of puts calculate_balance(march) because that is the last argument used in the iteration of the balance calculation. To fix the code, you would have to add the returns of the balance arguments for all three months.

# Fix: Make an array of the balance for each month and add the sum of that for the final balance
...
[january, february, march].each do |month|
  balance_months << calculate_balance(month)
end


puts balance = balance_months.sum
